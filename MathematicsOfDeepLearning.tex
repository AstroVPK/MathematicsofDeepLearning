...
The $\un^{[l]}$ operator returns the number of nodes, i.e. the width, of the $l$-th layer. Traditionally, the depth of the neural network is denoted by $L$, and hence we must have $0 \leq l \leq L$. The $0$-th layer is a pure input layer i.e. it has no transformation associated with it.
