...
\begin{equation*}
  \frac{\uderivative \mathscr{L}}{\uderivative X^{(m)}_{a'b'c'}} = \sum_{dabc}^{MHWC} \frac{\partial \mathscr{L}}{\partial Y^{(d)}_{abc}} \frac{\uderivative Y^{(d)}_{abc}}{\uderivative X^{(m)}_{a'b'c'}}.
\end{equation*}
Now
\begin{equation*}
  \frac{\uderivative Y^{(d)}_{abc}}{\uderivative X^{(m)}_{a'b'c'}} = \delta_{dm}
\end{equation*}
